...
abstract class BaseAdapter<T : Eigenvalue> : ListAdapter<Eigenvalue, BaseAdapter.BaseViewHolder<T>>(
    ...
    abstract class BaseViewHolder<T : Eigenvalue>(view: View) : RecyclerView.ViewHolder(view) {
